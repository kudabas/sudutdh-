<template>
  <div id="hero">
    <div class="pt-[100px] h-[310px] lg:pt-atas 2xl:px-60 lg:h-[600px] flex-container bg-cats bg-contain bg-no-repeat lg:bg-cats lg:bg-cover bg-center">
      <div class="flex flex-wrap">
        <div class="mt-[120px] mx-auto lg:mx-0 lg:mt-[470px]">
          <a href="https://wa.me/6283131462238"
            class="transition duration-300 ease-in-out hover:bg-primary hover:text-bodas text-primary border-2 border-primary font-bold bg-bodas py-3 px-12 rounded-xl">Consultation
            NOW !</a>
        </div>
        ...
        <!-- <div class="w-full self-center pl-16 lg:w-1/2">
          ...
          <h1 class="text-lg font-bold mt-10">
            SCIENTIFICS <span class="text-primary">RESEARCH</span>
